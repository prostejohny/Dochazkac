...
#### Sekce administrace
* **Exporty a logy:** Prohlížení chronologicky seřazené docházky. Rozšířené filtry (datum od-do, hledání dle jména). Generování výstupů do formátu XLSX s vloženým logem školy. Zobrazení logů přístupů administrátorů (auditní stopa s barevným odlišením neúspěšných pokusů). Zobrazení aktuálního počtu zaměstnanců ve škole. ([Příkladný XLSX zde](https://github.com/prostejohny/Dochazkac/blob/main/ukazkove_screenshoty_soubory/Dochazka_V%C5%A1ichni_zam%C4%9Bstnanci_2026-05-02.xlsx))
